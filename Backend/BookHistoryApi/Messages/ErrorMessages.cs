namespace BookHistoryApi.Messages
{
    public static class ErrorMessages
    {
        ...
        public const string TitleNotNullOrWhiteSpace = "Title cannot be empty or consist only of whitespace.";
        public const string ShortDescriptionMaxLength = "Short description must be a maximum of 1000 characters.";
        ...
        public const string AuthorNameMaxLength = "Author name must be a maximum of 255 characters.";
        public const string AuthorNotNullOrWhiteSpace = "Author cannot be empty or consist only of whitespace.";
        public const string InvalidDayErrorMessage = "Invalid date: Day is not valid for the given month.";
        public const string InvalidMonthErrorMessage = "Invalid date: Month must be between 1 and 12.";
        ...
        public const string BookIdMismatch = "The provided book ID does not match the ID of the book being updated.";
